...
const Avatar = ({ name, variant = 'default', className, ...rest }: AvatarProps) => {
  return (
    <div
      className={clsx(
        'inline-flex h-9 w-9 items-center justify-center rounded-full text-xs font-semibold uppercase',
